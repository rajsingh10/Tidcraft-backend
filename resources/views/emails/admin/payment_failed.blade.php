...
<head>
    ...
    <style>
        ...
        .details-box { background-color: #fef2f2; border-radius: 10px; padding: 25px; margin-bottom: 25px; display: flex; align-items: center; text-align: left; border: 1px solid #fca5a5; }
        .details-icon { width: 60px; height: 60px; background-color: #fee2e2; color: #ef4444; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-right: 25px; flex-shrink: 0; }
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <h1 class="title">Payment Failed Alert</h1>
            
            <p class="greeting">Hello Admin,</p>
            <p class="message">
                A payment attempt from a client has failed. Please review the transaction details below.
            </p>
            ...
            <div class="action-box">
                ...
                <div class="action-text">
                    <h4>Actions</h4>
                    <p>You can view the client details and failed payment information from the admin panel.</p>
            ...
            <div class="note-box">
                ...
                <div class="note-text">
                    <h4>Note</h4>
                    <p>This is an automated notification. If this client attempts the payment again successfully, a new success alert will be generated.</p>
                </div>
            </div>
